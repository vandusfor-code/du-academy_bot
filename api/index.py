...
async def consultar_du_bot(mensaje_usuario: str, nombre_asesora: str, numero: str) -> str:
    ...
    system_instruction = (
        ...
        "4. Si la pregunta no tiene relación con Cofrem, cajas de compensación familiar, o trámites/procesos laborales de la "
        "asesora, no la respondas: decile amablemente que eso no es tu área y que estás ahí para ayudarla con temas de Cofrem.\n"
